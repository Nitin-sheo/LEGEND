...
TELEGRAM_BOT_TOKEN = '8119119323:AAFzluQGo7R0lWmg-UYmBFNbUWtW8hIkQDU'

# Allow multiple user IDs
ALLOWED_USER_IDS = [5670958127, 7007814748]  # Add more user IDs as needed
